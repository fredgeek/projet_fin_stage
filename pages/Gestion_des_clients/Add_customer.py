...
class ajout_clients:
    def __init__(self, root, width, height):
        ...
        Label(self.page,text="Sexe : ",font=self.fonts,bg="#1c141f",fg="pink" ).place(x=440, y=200)
        i = IntVar()
        Radiobutton(self.page, text="Homme", value=1, variable=i,bg="#1c141f",activebackgroun="#1c141f" ,font=self.fonts,fg="pink").place(x=500, y=200)
        Radiobutton(self.page, text="Femme", value=2, variable=i,bg="#1c141f",activebackground="#1c141f" ,font=self.fonts,fg="pink").place(x=605,y=200)
        ...
        Button(self.page, text="Tous effacer ", font=self.fonts,bg="#1c141f", fg="cadetblue1",bd=0).place(x=380, y=395)
