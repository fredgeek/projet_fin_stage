...
class ajout_client :
    def __init__(self,root,width,height):
        ...
        Label(self.page,text="Entrer les informations du nouveu client a enregistrer . " ,font=self.fonts, bg="#333333",fg="pink" ).place(x=130,y=80)
        self.fonts = ('Arial',14,'bold')
        ...
        Button(self.page,font=self.fonts,text="Mes Clients",bg="#333333",fg="cadetblue1",bd=0,activebackground="#333333").place(x=540,y=450)
