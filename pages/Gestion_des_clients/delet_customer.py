...
class ajout_employer :
    def __init__(self,root,width,height):
        ...
        Label(self.page,text="entrer les information du client a supprimer. " ,font=self.fonts, bg="#333333",fg="pink" ).place(x=130,y=80)
        self.fonts = ('Arial',14,'bold')
        ...
        Button(self.page,text="Suprimer",font=self.fonts, bg="#333333",fg="cadetblue1",bd=0,activebackground="#333333").place(x=215,y=320,)
