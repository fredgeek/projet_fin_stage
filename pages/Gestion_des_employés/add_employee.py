...
class ajout_employer :
    def __init__(self,root,width,height):
        ...
        Label(self.page, text="Tel  ", font=self.fonts, bg="#333333", fg="pink").place(x=200, y=210)
        Entry(self.page, font=self.fonts).place(x=360, y=210)
        Button(self.page,text="Enregistrer",font=self.fonts, bg="#333333",fg="cadetblue1").place(x=215,y=320)
        Button(self.page,text="Effacer ",font=self.fonts, bg="#333333",fg="cadetblue1").place(x=215,y=320)
