...
############################   création du canvas d'affichage   ######################
        ...
        self.dat = DateEntry(self.page, bg="#05716c").place(x=290,y=84)
        ...
        i=IntVar()
        Radiobutton(self.page, text="Encaissement",value=1,variable=i, bg="#05716c",font=("Arial",12,"italic"),activebackground="#05716c").place(x=120,y=150)
        Radiobutton(self.page, text="Décaissement",value=2,variable=i, bg="#05716c",font=("Arial",12,"italic"),activebackground="#05716c").place(x=280,y=150)
##################### bouton des facture traités et non traités ###############################
        Label(self.page, text="STATUS : ",fg="black", font=("Arial",14,"bold"),bg="#05716c").place(x=120,y=180)
        j = IntVar()
        Radiobutton(self.page, text="Traité", value=1, variable=j, bg="#05716c", font=("Arial", 12, "italic"),
                    activebackground="#05716c").place(x=250, y=180)
        Radiobutton(self.page, text="Non Traité", value=2, variable=j, bg="#05716c", font=("Arial", 12, "italic"),
                    activebackground="#05716c").place(x=350, y=180)
...
################################  bouton pour modifier le status d'une facture ##############################
        ...
        Button(self.page, text="Modif.stat", font=("arial", 9, "italic"), bg="#05716c", fg="black",
