...
class mon_compte:
    ...
    def __init__(self, root, width, height):
        ...
        Label(self.page, text="consulter vos informations personelles: ",font=self.fonts
              ,bg="#7fc3c0").place(x=self.width/4,y=4)
        ...
        Label(self.page, text="Email : ",font=self.fonts,bg="#7fc3c0").place(x=50, y=300)
        email = " username_email"
        Label(self.page, text=f"{email} ",font=("arial",12,"roman"),bg="#7fc3c0").place(x=250, y=300)

        Label(self.page, text="Mot de passe : ",font=self.fonts,bg="#7fc3c0").place(x=50, y=400)
        password = " username_password"
        Label(self.page, text=f"{password} ",font=("arial",12,"roman"),bg="#7fc3c0").place(x=250, y=400)
